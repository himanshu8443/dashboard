...
const Modal = ({ setShowModal }) => {
    ...
    return (
        <div className=' fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center overflow-scroll'
            ...
            <div className=' bg-white p-4 rounded-md shadow-md overflow-scrolls w-[90vw]  md:w-[700px]'
                    ...
                    <div className='flex flex-col gap-8 justify-center items-starts'>
                        ...
                        <div className='flex flex-col gap-2 ml-4'>
                            <div className=' gap-8 justify-between items-center hidden md:flex'>
                                ...
                                <p className=' text-lg font-medium mr-5'>₹ {durationMultiplier} X {duration}</p>
                            </div>
                            <div className=' gap-8 justify-between items-center hidden md:flex'>
                                <label className=' text-lg font-medium whitespace-nowrap'>Invitation Cost</label>
                                <p className=' text-lg font-medium mr-5'>₹ {basePrice} X {noOfInvites}</p>
                            </div>
